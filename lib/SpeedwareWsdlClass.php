<?php
/**
 * File for SpeedwareWsdlClass to communicate with SOAP service
 * @package Speedware
 ...
 */
/**
 * SpeedwareWsdlClass to communicate with SOAP service
 * 
 * @package Speedware
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 * @version 20130801-01
 * @date 2013-08-06
 */
class SpeedwareWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SpeedwareWsdlClass::setLastError()
	 * @uses SpeedwareWsdlClass::initSoapClient()
	 * @uses SpeedwareWsdlClass::initInternArrayToIterate()
	 * @uses SpeedwareWsdlClass::_set()
	 ...
	 * @return SpeedwareWsdlClass|null
	 */
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'SpeedwareWsdlClass'))
			{
	 ...
	 * @uses SpeedwareClassMap::classMap()
	 * @uses SpeedwareWsdlClass::getDefaultWsdlOptions()
	 * @uses SpeedwareWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SpeedwareClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SpeedwareClassMap::classMap();
	 ...
	 * @uses SpeedwareWsdlClass::WSDL_CACHE_WSDL
	 * @uses SpeedwareWsdlClass::WSDL_COMPRESSION
	 * @uses SpeedwareWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SpeedwareWsdlClass::WSDL_ENCODING
	 * @uses SpeedwareWsdlClass::WSDL_EXCPTS
	 * @uses SpeedwareWsdlClass::WSDL_FEATURES
	 * @uses SpeedwareWsdlClass::WSDL_LOGIN
	 * @uses SpeedwareWsdlClass::WSDL_PASSWD
	 * @uses SpeedwareWsdlClass::WSDL_SOAP_VERSION
	 * @uses SpeedwareWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SpeedwareWsdlClass::WSDL_TRACE
	 * @uses SpeedwareWsdlClass::WSDL_TYPEMAP
	 * @uses SpeedwareWsdlClass::WSDL_URL
	 * @uses SpeedwareWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SpeedwareWsdlClass::getSoapClient()
	 * @uses SpeedwareWsdlClass::getFormatedXml()
	 ...
	 * @uses SpeedwareWsdlClass::getSoapClient()
	 * @uses SpeedwareWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses SpeedwareWsdlClass::getInternArrayToIterate()
	 * @uses SpeedwareWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses SpeedwareWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SpeedwareWsdlClass::getInternArrayToIterateOffset()
	 * @uses SpeedwareWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SpeedwareWsdlClass::getInternArrayToIterateOffset()
	 * @uses SpeedwareWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @see SpeedwareWsdlClass::offsetGet()
	 * @uses SpeedwareWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses SpeedwareWsdlClass::getAttributeName()
	 * @uses SpeedwareWsdlClass::__toString()
	 * @uses SpeedwareWsdlClass::_set()
	 * @uses SpeedwareWsdlClass::_get()
	 * @uses SpeedwareWsdlClass::setInternArrayToIterate()
	 * @uses SpeedwareWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SpeedwareWsdlClass::setInternArrayToIterateOffset()
	 ...
	 * @uses SpeedwareWsdlClass::item()
	 * @uses SpeedwareWsdlClass::length()
	 * @return mixed
	 */

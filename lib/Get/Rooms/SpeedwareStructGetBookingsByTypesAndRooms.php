<?php
/**
 * File for class SpeedwareStructGetBookingsByTypesAndRooms
 * @package Speedware
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedwareStructGetBookingsByTypesAndRooms originally named GetBookingsByTypesAndRooms
 ...
 * @date 2013-08-06
 */
class SpeedwareStructGetBookingsByTypesAndRooms extends SpeedwareWsdlClass
{
	/**
	...
	public $RoomIDs;
	/**
	 * Constructor method for GetBookingsByTypesAndRooms
	 ...
	 * @return SpeedwareStructGetBookingsByTypesAndRooms
	 */

<?php
/**
 * File for class SpeedwareStructGetBookingsByTypesAndRoomsFutureOnly
 * @package Speedware
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedwareStructGetBookingsByTypesAndRoomsFutureOnly originally named GetBookingsByTypesAndRoomsFutureOnly
 ...
 * @date 2013-08-06
 */
class SpeedwareStructGetBookingsByTypesAndRoomsFutureOnly extends SpeedwareWsdlClass
{
	/**
	...
	public $RoomIDs;
	/**
	 * Constructor method for GetBookingsByTypesAndRoomsFutureOnly
	 ...
	 * @return SpeedwareStructGetBookingsByTypesAndRoomsFutureOnly
	 */

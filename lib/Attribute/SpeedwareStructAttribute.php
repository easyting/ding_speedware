<?php
/**
 * File for class SpeedwareStructAttribute
 * @package Speedware
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedwareStructAttribute originally named Attribute
 ...
 * @date 2013-08-06
 */
class SpeedwareStructAttribute extends SpeedwareWsdlClass
{
	/**
	 * The Sequence
	 * Meta informations extracted from the WSDL
